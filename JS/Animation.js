...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Blob config
  const blobs = [
    { x: 180, y: 120, r: 90, color: 'rgba(30,144,255,0.18)', dx: 0.5, dy: 0.3 },
    { x: 420, y: 200, r: 70, color: 'rgba(0,198,251,0.14)', dx: -0.4, dy: 0.2 },
    { x: 320, y: 260, r: 60, color: 'rgba(30,144,255,0.12)', dx: 0.3, dy: -0.3 }
  ];
...
createSectionBlobs('about-joga-canvas', [
  { x: 120, y: 100, r: 70, color: 'rgba(30,144,255,0.13)', dx: 0.3, dy: 0.2 },
  { x: 400, y: 180, r: 60, color: 'rgba(0,198,251,0.10)', dx: -0.2, dy: 0.15 }
]);

// Our Story section blobs
createSectionBlobs('about-story-canvas', [
  { x: 200, y: 120, r: 80, color: 'rgba(30,144,255,0.10)', dx: 0.2, dy: 0.18 },
  { x: 500, y: 200, r: 60, color: 'rgba(0,198,251,0.09)', dx: -0.18, dy: 0.13 }
]);
